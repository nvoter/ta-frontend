    ...
    <section className="dashboard-shell" aria-labelledby="student-application-create-title">
      ...
      <section className="dashboard-hero">
        <div className="dashboard-hero__copy">
          ...
          <p>{isEditMode ? 'Данные можно редактировать только у заявок со статусом «Новая». Если заявке уже присвоен статус «Заинтересован» или «На согласовании», обратитесь к преподавателю или администратору, чтобы вернуть её в статус «Новая». После правок преподавателю нужно будет повторно установить статус «Заинтересован» (если ваша договорённость сохраняется в силе).' : 'Для подачи заявки заполните форму'}</p>
        </div>
      </section>
      ...
      <form className="application-form" onSubmit={handleSubmit} noValidate>
        ...
        <div className="application-form__alert" role="note">
          <p>
            ...
            и изучите{' '}
            <a
              href={appRoutes.studentDisciplines}
              onClick={(event) => {
                event.preventDefault()
                navigateTo(appRoutes.studentDisciplines)
              }}
            >
              перечень дисциплин
            </a>
      ...
      <div className="discipline-card__layout">
        <div className="discipline-card__column">
          ...
          <TextAreaField
            ...
            hint={
              <>
                <span>Напишите, почему вы хотите стать ассистентом, перечислите учебные достижения и опишите опыт по смежным курсам.</span>
                <span>Если есть рекомендация от преподавателя, укажите его ФИО и почту.</span>
              </>
            }
        ...
        <div className="discipline-card__column discipline-card__column--between">
          ...
          <div className="checkbox-field discipline-card__checkbox-group discipline-card__checkbox-group--confirmation">
            <label className="checkbox-field__label" htmlFor={`${item.id}-grade-confirmation`}>
              ...
              <span className="checkbox-field__box" aria-hidden="true" />
              <span className="checkbox-field__text">
                Подтверждаю, что указанная мною оценка соответствует оценке, выставленной преподавателем в ведомость. Осознаю, что подача недостоверных сведений приведет к аннулированию моей заявки
              </span>
            </label>
          </div>
        </div>
